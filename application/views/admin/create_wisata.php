                         ...
                         <div class="col-lg-8 col-12">
                             ...
                             <div class="card">
                                 <div class="card-header">
                                     <h3 class="card-title">Form Create Wisata</h3>

                                     <div class="card-tools">
                                         <a class="btn btn-sm btn-primaryku" data-toggle="modal" data-target="#modalMaps"><i class="fa fa-map"></i> Get Location</a>
                                         <a href="<?= base_url('wisata') ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Back</a>
                                     </div>
                                 </div>
                                 <div class="card-body p-0">
                                     <form class="form-horizontal" id="wisataForm" method="post" enctype="multipart/form-data">
                                         <div class="card-body">
                                             <div class="form-group row">
                                                 <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Wisata</label>
                                                 <div class="col-sm-9">
                                                     <input type="text" name="nama_wisata" class="form-control" id="nama_wisata" placeholder="Nama Wisata" autocomplete="off" required>
                                                 </div>
                                             </div>
                                             ...
                                             <div class="form-group row">
                                                 ...
                                                 <div class="col-sm-9">
                                                     <textarea name="alamat_lengkap" id="alamat_lengkap" cols="2" rows="4" class="form-control" placeholder="Alamat Lengkap" required></textarea>
                                                 </div>
                                             </div>
                                             ...
                                             <div class="form-group row">
                                                 ...
                                                 <div class="col-sm-9">
                                                     <textarea name="deskripsi" id="deskripsi" cols="2" rows="10" class="form-control" placeholder="Deskripsi wisata" required></textarea>
                                                 </div>
                                             </div>
